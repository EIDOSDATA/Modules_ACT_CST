...
void MX_GPIO_Init(void)
{
	...
	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, PHOTO_PULSE0_Pin | PHOTO_PULSE1_Pin | IR_PULSE0_Pin | SW_1_Pin | IR_PULSE1_Pin | IR_PULSE2_Pin | IR_PULSE3_Pin, GPIO_PIN_RESET);
	...
	/*Configure GPIO pins : PBPin PBPin PBPin PBPin
	 PBPin PBPin PBPin */
	GPIO_InitStruct.Pin = PHOTO_PULSE0_Pin | PHOTO_PULSE1_Pin | IR_PULSE0_Pin | SW_1_Pin | IR_PULSE1_Pin | IR_PULSE2_Pin | IR_PULSE3_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
